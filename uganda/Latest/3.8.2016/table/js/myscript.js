...
function _init() {
    ...
    $.moests.layout = {
        ...
        fix: function() {
            ...
            if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight());
                ...
                var e = $($.moests.options.controlSidebarOptions.selector);
                "undefined" != typeof e && e.height() > d && $(".content-wrapper, .right-side").css("min-height", e.height())
            }
        },
        fixSidebar: function() {
            return $("body").hasClass("fixed") ? ("undefined" == typeof $.fn.slimScroll && window.console && window.console.error("Error: the fixed layout requires the slimscroll plugin!"), void($.moests.options.sidebarSlimScroll && "undefined" != typeof $.fn.slimScroll && ($(".sidebar").slimScroll({
                destroy: !0
        ...
        activate: function(a) {
            var b = $.moests.options.screenSizes;
            ...
            }), ($.moests.options.sidebarExpandOnHover || $("body").hasClass("fixed") && $("body").hasClass("sidebar-mini")) && this.expandOnHover()
        },
        expandOnHover: function() {
            var a = this,
                b = $.moests.options.screenSizes.sm - 1;
    ...
    }, $.moests.tree = function(a) {
        var b = this,
            c = $.moests.options.animationSpeed;
    ...
    }, $.moests.controlSidebar = {
        activate: function() {
            var a = this,
                b = $.moests.options.controlSidebarOptions,
                c = $(b.selector),
        ...
        selectors: $.moests.options.boxWidgetOptions.boxWidgetSelectors,
        icons: $.moests.options.boxWidgetOptions.boxWidgetIcons,
        animationSpeed: $.moests.options.animationSpeed,
        activate: function(a) {
            var b = this;
...
if ("undefined" == typeof jQuery) throw new Error("moests requires jQuery");
$.moests = {}, $.moests.options = {
        ...
        "use strict";
        $("body").removeClass("hold-transition"), "undefined" != typeof moestsOptions && $.extend(!0, $.moests.options, moestsOptions);
        var a = $.moests.options;
        _init(), $.moests.layout.activate(), $.moests.tree(".sidebar"), a.enableControlSidebar && $.moests.controlSidebar.activate(), a.navbarMenuSlimscroll && "undefined" != typeof $.fn.slimscroll && $(".navbar .menu").slimscroll({
            height: a.navbarMenuHeight,
            alwaysVisible: !1,
            size: a.navbarMenuSlimscrollWidth
        }).css("width", "100%"), a.sidebarPushMenu && $.moests.pushMenu.activate(a.sidebarToggleSelector), a.enableBSToppltip && $("body").tooltip({
            selector: a.BSTooltipSelector
        }), a.enableBoxWidget && $.moests.boxWidget.activate(), a.enableFastclick && "undefined" != typeof FastClick && FastClick.attach(document.body), a.directChat.enable && $(document).on("click", a.directChat.contactToggleSelector, function() {
    ...
    function(a) {
        ...
        a.fn.activateBox = function() {
            a.moests.boxWidget.activate(this)
        }, a.fn.toggleBox = function() {
            var b = a(a.moests.boxWidget.selectors.collapse, this);
            a.moests.boxWidget.collapse(b)
        }, a.fn.removeBox = function() {
            var b = a(a.moests.boxWidget.selectors.remove, this);
            a.moests.boxWidget.remove(b)
        }
    }(jQuery),
    function(a) {
        "use strict";
