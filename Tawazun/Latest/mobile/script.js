  ...
  $(document).on('click', function(e) {
   ...
   function documentfolder() {
        ...
        $('.document_folder .files_container').mouseover(function () {
          ...
          $(this).find(".folder a img").attr("src", "../style library/tawazun/images/folder_1.png");
          $(this).find(".more").css("visibility","visible");
        }).mouseout(function () {
          $(this).find(".folder a img").attr("src", "../style library/tawazun/images/folder_2.png");
    ...
    function chatbot()
    {
       ...
       var chatUserName="";
       if(_spPageContextInfo.userLoginName!="SHAREPOINT\system")
       {
       		chatUserName=_spPageContextInfo.userLoginName;
       }
       else
       {
       		chatUserName="administrator";
       }
       //console.log(_spPageContextInfo.userLoginName);
                  if (!jQuery(this).hasClass('active')) {                    
                    jQuery('.bluefish-messenger a').addClass('active');
                    jQuery('.bluefish-messenger').show();
                    if(jQuery("#bluefishIframe").contents().find("body").length) {
                        jQuery("#bluefishIframe").attr("src", "http://10.100.100.56:5555/tawazun_login/5dc3bb500a98e76b647cc76d?username="+chatUserName);
                    }
                  } else {                    
                    jQuery('.bluefish-messenger a').removeClass('active');
                    jQuery('.bluefish-messenger').hide();
                  }
                  return false;
                });
