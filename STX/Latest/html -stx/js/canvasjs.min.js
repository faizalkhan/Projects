...
(function() {
    ...
    function Ra(a) {
        if (!Aa) {
            var c = !1,
                b = !1;
            "undefined" === typeof ba.Chart.creditHref ? (a.creditHref = "https://google.com/", a.creditText =
    ...
    function ma(a, c) {
        ...
        if (z(this.options.margin) && a.options.subtitles)
            for (var b = a.options.subtitles, d = 0; d < b.length; d++)
                if ((z(b[d].horizontalAlign) && "center" === this.horizontalAlign || b[d].horizontalAlign === this.horizontalAlign) && (z(b[d].verticalAlign) && "top" === this.verticalAlign || b[d].verticalAlign === this.verticalAlign) && !b[d].dockInsidePlotArea === !this.dockInsidePlotArea) {
                    this.margin = 0;
                    break
                }
    ...
    (function() {
        function a(a) {
            var b = RegExp(A.ckDec(A.str.ckn) + "=.*", "gi"),
                ...
                JSON.parse(localStorage.getItem("lclStg")).name.match(A.ckDec(A.str.ckn)) ? JSON.parse(localStorage.getItem("lclStg")) : null;
            if (f && 0 < f.length || b) {
                var g;
                g = [];
                var l = [],
                ...
                if (!z(ja[A.ckDec(A.str.sk)]) &&
                    "string" === typeof ja[A.ckDec(A.str.sk)] && ja[A.ckDec(A.str.sk)]) {
                    g = ja[A.ckDec(A.str.sk)];
                ...
                }, document.cookie = A.ckDec(A.str.ckn) + "=" + (new Date).getTime() + "; " + A.ckDec(A.str.ckve) + a.toUTCString() + "; path=/;", localStorage.setItem("lclStg", JSON.stringify(b));
            return !1
        }
        A.fSDec = function(a) {
        ...
        A.str = {
            tv: [195, 225, 216, 208, 219, 143, 197, 212, 225, 226, 216, 222, 221],
        ...
        delete ba[A.fSDec([178, 215, 208, 225, 227])][A.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])];
        A.pro = {
        ...
        A.fAWm = function(c) {
            if ("undefined" === typeof A.pro.sCH && !Aa) try {
                if (a(2)) {
                    var b = c[A.fSDec(A.str.ct)];
                    b[A.fSDec(A.str.tBl)] = A.fSDec(A.str.tp);
                    b[A.fSDec(A.str.fnt)] = 11 + A.fSDec(A.str.fntStr);
                    b[A.fSDec(A.str.fSy)] = A.fSDec(A.str.gr);
                    b[A.fSDec(A.str.fTx)](A.fSDec(A.str.tv), 2, c.height - 11 - 2)
                }
            } catch (d) {}
        };
        A.ckDec = function(a) {
        ...
        A.str.tem = [200, 222, 228, 225, 143, 195, 225, 216, 208, 219, 143, 191, 212, 225, 216, 222, 211, 143, 215, 208, 226, 143, 180, 231, 223, 216, 225, 212, 211, 144];
        A.str.ctm = [191, 219, 212, 208, 226, 212, 143, 223, 228, 225, 210, 215, 208, 226, 212, 143, 219, 216, 210, 212, 221, 226, 212, 143, 227, 222, 143, 225, 212, 220, 222, 229, 212, 143, 227, 215, 216, 226, 143, 230, 208, 227, 212, 225, 220, 208, 225, 218, 157];
        A.str.ltm = [181, 222, 225, 143, 208, 221, 232, 143, 212, 221, 224, 228, 216, 225, 216, 212, 226, 143, 210, 222, 221, 227, 208, 210, 227, 143, 226, 208, 219, 212, 226,
            175, 210, 208, 221, 229, 208, 226, 217, 226, 157, 210, 222, 220
        ];
        A.str.ckve = [212, 231, 223, 216, 225, 212, 226, 172];
        ...
        A.fNg = function(c) {
            if (!Aa) try {
                if (a(60)) {
                    var b = 24,
                        d = c.plotArea.ctx;
                    d.font = "bold " + b + (t ? "px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif" :
                        "px Lucida Sans Unicode");
                    var f = A.ckDec(A.str.tem),
                        g = d.measureText(f).width;
                    d.fillStyle = t ? A.ckDec(A.str.mco) : A.ckDec(A.str.mcw);
                    d.fillRect(c.plotArea.x2 - g - 8, c.plotArea.y2 - 2.5 * b - 8, g + 4, 2.5 * b + 8);
                    d.fillStyle = t ? A.ckDec(A.str.mct) : A.ckDec(A.str.mcr);
                    d.textBaseline = "top";
                    ...
                    f = A.ckDec(A.str.ctm);
                    g = d.measureText(f).width;
                    d.fillStyle = t ? A.ckDec(A.str.mct) :
                        A.ckDec(A.str.mcr);
    ...
    L.prototype.get = function(a) {
        ...
        if ("options" === a) return this.options && this.options._isPlaceholder ?
            null : this.options;
    ...
    L.prototype.set = function(a, c, b) {
        ...
        else if (d.hasOwnProperty(a) || d.publicProperties && d.publicProperties.hasOwnProperty(a) && "readWrite" === d.publicProperties[a]) this.options._isPlaceholder && this.createUserOptions(),
            this.options[a] = c;
        else {
    ...
    L.prototype.addTo = function(a, c, b, d) {
        ...
        f.hasOwnProperty(a) || f.publicProperties && f.publicProperties.hasOwnProperty(a) && "readWrite" === f.publicProperties[a] ?
    ...
    L.prototype.createUserOptions = function(a) {
        if ("undefined" !==
            ...
            if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
                ...
                c[b] = this.options
            } else this.options = "undefined" === typeof a ? {} : a, a = this.parent.options, this.optionsName ? c = this.optionsName : (c = this._defaultsKey) &&
                0 !== c.length ? (b = c.charAt(0).toLowerCase(), 1 < c.length && (b = b.concat(c.slice(1))), c = b) : c = void 0, a[c] = this.options
    };
    ...
    L.prototype.updateOption = function(a) {
        var c = ba[this._defaultsKey],
            b = this.options.theme ? this.options.theme : this.chart && this.chart.options.theme ?
            this.chart.options.theme : "theme1",
            d = {},
            f = this[a];
    ...
    L.prototype.isBeingTracked = function(a) {
        ...
        return this.options._oldOptions[a] ? !0 :
            !1
    };
    ...
    B.prototype._updateOptions =
        function() {
            ...
            this.options.zoomEnabled ? (this._zoomButton || (Z(this._zoomButton = document.createElement("button")), R(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton),
                ...
                a.toolTip.hide();
                a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, R(a, a._zoomButton, "pan"), a._defaultCursor = "default",
                    a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1);
                ...
                if (a.sessionVariables.axisY)
                    for (b = 0; b < a.sessionVariables.axisY.length; b++) a.sessionVariables.axisY[b].newViewportMinimum =
                        null, a.sessionVariables.axisY[b].newViewportMaximum = null;
            ...
            }), this.overlaidCanvas.style.cursor = a._defaultCursor), this.zoomEnabled || this.panEnabled || (this._zoomButton ?
                (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled = !1), ta(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0, this.panEnabled = !1))) : this.panEnabled = this.zoomEnabled = !1;
            this._menuButton ? this.exportEnabled ? ta(this._menuButton) : Z(this._menuButton) : this.exportEnabled && t && (this._menuButton = document.createElement("button"), R(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), J(this._menuButton,
                "click",
                function() {
    ...
    B.prototype.render = function(a) {
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (var l = this.plotInfo.plotTypes[a], k = 0; k < l.plotUnits.length; k++) {
                var h =
                    ...
                    m = null;
                h.targetCanvas = null;
                this.animatedRender && (h.targetCanvas = fa(this.width, this.height), h.targetCanvasCtx = h.targetCanvas.getContext("2d"), g = h.targetCanvasCtx.miterLimit, h.targetCanvasCtx.miterLimit = 3);
                "line" === h.type ? m = this.renderLine(h) : "stepLine" === h.type ? m = this.renderStepLine(h) : "spline" === h.type ? m = this.renderSpline(h) : "column" === h.type ? m = this.renderColumn(h) : "bar" === h.type ? m = this.renderBar(h) : "area" === h.type ? m = this.renderArea(h) : "stepArea" === h.type ? m = this.renderStepArea(h) : "splineArea" ===
                    ...
                    this.renderPie(h) : "candlestick" === h.type ? m = this.renderCandlestick(h) : "ohlc" === h.type ? m = this.renderCandlestick(h) : "rangeColumn" === h.type ? m = this.renderRangeColumn(h) : "rangeBar" === h.type ? m = this.renderRangeBar(h) : "rangeArea" === h.type ? m = this.renderRangeArea(h) : "rangeSplineArea" === h.type && (m = this.renderRangeSplineArea(h));
        ...
        0 < d.length ? (p.disableToolTip = !0, p._animator.animate(200, p.animationDuration, function(a) {
            ...
            for (var b = 0; b < d.length; b++) m = d[b], 1 > a && "undefined" !== typeof m.startTimePercent ? a >= m.startTimePercent && m.animationCallback(m.easingFunction(a - m.startTimePercent,
                0, 1, 1 - m.startTimePercent), m) : m.animationCallback(m.easingFunction(a, 0, 1, 1), m);
        ...
        this.zoomEnabled || (this.panEnabled || !this._zoomButton ||
            "none" === this._zoomButton.style.display) || Z(this._zoomButton, this._resetButton);
    ...
    B.prototype.categoriseDataSeries = function() {
        for (var a = "", c = 0; c < this.data.length; c++)
            if (a = this.data[c], a.dataPoints &&
                (0 !== a.dataPoints.length && a.visible) && 0 <= B._supportedChartTypes.indexOf(a.type)) {
                ...
                for (l = 0; l < b.plotUnits.length; l++)
                    if (b.plotUnits[l].axisYType === a.axisYType && b.plotUnits[l].axisXType === a.axisXType && b.plotUnits[l].axisYIndex === a.axisYIndex && b.plotUnits[l].axisXIndex ===
                        a.axisXIndex) {
                        g = !0;
                        f = b.plotUnits[l];
                        break
    ...
    B.prototype.assignIdToDataPoints = function() {
        for (var a = 0; a < this.data.length; a++) {
            ...
            if (c.dataPoints)
                for (var b =
                        c.dataPoints.length, d = 0; d < b; d++) c.dataPointIds[d] = ++this._eventManager.lastObjectId
        }
    };
    B.prototype._processData = function() {
        ...
        for (var a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (var c = this.plotInfo.plotTypes[a], b = 0; b < c.plotUnits.length; b++) {
                var d = c.plotUnits[b];
                "line" === d.type || "stepLine" === d.type || "spline" === d.type || "column" === d.type || "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "bar" === d.type || "bubble" === d.type || "scatter" === d.type ?
                    this._processMultiseriesPlotUnit(d) : "stackedColumn" === d.type || "stackedBar" === d.type || "stackedArea" === d.type ? this._processStackedPlotUnit(d) : "stackedColumn100" === d.type || "stackedBar100" === d.type || "stackedArea100" === d.type ? this._processStacked100PlotUnit(d) : "candlestick" !== d.type && "ohlc" !== d.type && "rangeColumn" !== d.type && "rangeBar" !== d.type && "rangeArea" !== d.type && "rangeSplineArea" !== d.type || this._processMultiYPlotUnit(d)
            }
    };
        ...
        if (a.dataSeriesIndexes &&
            ...
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                for (h = 0; h < k.dataPoints.length; h++) {
                    ...
                    k.dataPoints[h].x.getTime ?
                        (g = !0, d = k.dataPoints[h].x.getTime()) : d = k.dataPoints[h].x;
                    f = k.dataPoints[h].y;
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    ...
                    if (0 < h) {
                        ...
                        null !== f && null !== k.dataPoints[h - 1].y && (a.axisY.logarithmic ? (r = f / k.dataPoints[h - 1].y, 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff =
                            r)) : (r = f - k.dataPoints[h - 1].y, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)))
                    }
                    if (d < e && !m) null !== f && (n = d);
                    else {
                        if (!m && (m = !0, 0 < h)) {
                ...
                this.plotInfo.axisXValueType =
                    k.xValueType = g ? "dateTime" : "number"
            }
    };
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, l = [], k = [], h = Infinity, m = -Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var n = this.data[a.dataSeriesIndexes[p]],
                    ...
                    r = !1,
                    s;
                if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var w = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX &&
                ...
                for (e = 0; e < n.dataPoints.length; e++) {
                    ...
                    if (0 < e) {
                        ...
                        null !== f && null !== n.dataPoints[e -
                            1].y && (a.axisY.logarithmic ? 0 < f && (y = f / n.dataPoints[e - 1].y, 1 > y && (y = 1 / y), c.minDiff > y && 1 !== y && (c.minDiff = y)) : (y = f - n.dataPoints[e - 1].y, 0 > y && (y *= -1), c.minDiff > y && 0 !== y && (c.minDiff = y)))
                    }
                    if (d < w && !q) null !== n.dataPoints[e].y && (s = d);
                        ...
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === n.dataPoints[e].y ? b.viewPortMin === d && s < d && (b.viewPortMin = s) :
                            (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(f), 0 <= f ? l[d] ? l[d] += f : (l[d] = f, h = Math.min(f, h)) : k[d] ? k[d] += f : (k[d] = f, m = Math.max(f, m)))
                    }
                }
            ...
            for (e in k) k.hasOwnProperty(e) && !isNaN(e) && (a = k[e], a < c.min && (c.min = a), a > c.max &&
                (c.max = Math.max(a, m)), e < b.viewPortMin || e > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = a), a > c.viewPortMax && (c.viewPortMax = Math.max(a, m))))
        }
    };
    B.prototype._processStacked100PlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, l = !1, k = !1, h = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (p.dataPoints[n].x &&
                    p.dataPoints[n].x.getTime || "dateTime" === p.xValueType) g = !0;
                for (n = 0; n < p.dataPoints.length; n++) {
                    ...
                    if (0 < n) {
                        ...
                        } else u = d - p.dataPoints[n - 1].x, 0 > u && (u *= -1), b.minDiff >
                            u && 0 !== u && (b.minDiff = u);
                        z(f) || null === p.dataPoints[n - 1].y || (a.axisY.logarithmic ? 0 < f && (u = f / p.dataPoints[n - 1].y, 1 > u && (u = 1 / u), c.minDiff > u && 1 !== u && (c.minDiff = u)) : (u = f - p.dataPoints[n - 1].y, 0 > u && (u *= -1), c.minDiff > u && 0 !== u && (c.minDiff = u)))
                    }
                    if (d < s && !e) null !== f && (r = d);
                    else {
                        if (!e && (e = !0, 0 < n)) {
                        ...
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null === f ? b.viewPortMin === d && r <
                            d && (b.viewPortMin = r) : (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(f), 0 <= f ? l = !0 : 0 > f && (k = !0), h[d] = h[d] ? h[d] + Math.abs(f) : Math.abs(f))
                    }
                }
                this.plotInfo.axisXValueType = p.xValueType = g ? "dateTime" : "number"
            }
            a.axisY.logarithmic ? (c.max = z(c.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(c.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), c.min = z(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : l && !k ? (c.max = z(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = z(c.viewPortMin) ? 1 : Math.min(c.viewPortMin,
                1)) : l && k ? (c.max = z(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = z(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99)) : !l && k && (c.max = z(c.viewPortMax) ? -1 : Math.max(c.viewPortMax, -1), c.min = z(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99));
            c.viewPortMin = c.min;
            c.viewPortMax = c.max;
            a.dataPointYSums = h
        }
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g, l, k = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
                var m =
                    ...
                    e = !1,
                    q, r, s;
                if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var w = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    g < c.min && (c.min = g);
                    l > c.max && (c.max = l);
                    0 < p && (a.axisX.logarithmic ? (r = d / m.dataPoints[p - 1].x, 1 > r && (r = 1 / r), b.minDiff > r && 1 !== r && (b.minDiff = r)) : (r = d - m.dataPoints[p - 1].x, 0 > r && (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r)), f && (null !== f[0] && m.dataPoints[p - 1].y && null !== m.dataPoints[p - 1].y[0]) && (a.axisY.logarithmic ? (r = f[0] / m.dataPoints[p - 1].y[0], 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff =
                        r)) : (r = f[0] - m.dataPoints[p - 1].y[0], 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r))));
                    if (!(d < w) || n) {
                        if (!n && (n = !0, 0 < p)) {
                            p -= 2;
                            q = s;
                        ...
                        null === f ? b.viewPortMin === d && q < d && (b.viewPortMin = q) : (g < c.viewPortMin && (c.viewPortMin = g), l > c.viewPortMax &&
                            (c.viewPortMax = l))
                    }
                }
    ...
    B.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        for (b = 0; b < d.length; b++)
            if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)
                if (f = K("markerSize", d[b].dataPoint, d[b].dataSeries) || 8,
                    d[b].distance <= f / 2) {
                    c = !0;
                    break
                }
    ...
    B.prototype.getObjectAtXY = function(a, c, b) {
        var d = null;
    ...
    B.prototype._mouseEventHandler = function(a) {
        ...
        B.capturedEventParam && (d = B.capturedEventParam, "mouseup" === b && (B.capturedEventParam = null, d.chart.overlaidCanvas.releaseCapture ?
            ...
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)
                    for (f = g = 0; f < this._axes.length; f++) b = this._axes[f], b.logarithmic ? b.viewportMinimum < b.minimum ? (g = b.minimum / b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum *
                        ...
                        b.viewportMinimum - g, b.sessionVariables.newViewportMaximum = b.viewportMaximum - g, l = !0);
                ...
                l && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged",
                    "zoom"), l && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (ta(this._zoomButton, this._resetButton), R(this, this._zoomButton, "pan"), R(this, this._resetButton, "reset")))
            }
        }
        this.isDrag = !1
    };
        ...
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))
                if (this.panEnabled) f = {
                    ...
                    return function() {
                        l._zoomPanToSelectedRegion(b,
                            d, e, f, !0) && (l._dispatchRangeEvent("rangeChanging", "pan"), l.render(), l._dispatchRangeEvent("rangeChanged", "pan"), l.dragStartPoint.x = a, l.dragStartPoint.y = c)
                    }
    ...
    B.prototype.validateRegion = function(a, c, b, d, f) {
        f = f || !1;
    ...
    B.prototype.preparePlotArea = function() {
        ...
        t || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top =
            a.y1 + "px", (0 < a.x1 || 0 < a.y1) && a.ctx.translate(-a.x1, -a.y1));
        a.layoutManager = new ia(a.x1, a.y1, a.x2, a.y2, 2)
    };
    B.prototype.renderIndexLabels = function(a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            if (null !== x && "" !== x) {
                ...
                if ("stackedarea100" === p) {
                    ...
                    if (m.dataPoint.x <
                        Y.viewportMinimum || m.dataPoint.x > Y.viewportMaximum || Math.max.apply(null, m.dataPoint.y) < A.viewportMinimum || Math.min.apply(null, m.dataPoint.y) > A.viewportMaximum) continue
                    ...
                    if (m.dataPoint.x < Y.viewportMinimum || m.dataPoint.x > Y.viewportMaximum ||
                        m.bounds.y1 > b.y2 || m.bounds.y2 < b.y1) continue
                ...
                f = l = 2;
                "horizontal" ===
                y ? (k = q.width, h = q.height) : (h = q.width, k = q.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    n = m.point.x - k / 2;
                    "inside" !== u ? (f = b.y1, g = b.y2, 0 < v ? (e = m.point.y - h - l - d, e < f && (e = "auto" === u ? Math.max(m.point.y, f) + l + d : f + l + d, B = e + h > m.point.y)) : (e = m.point.y + l + d, e > g - h - l - d && (e = "auto" === u ? Math.min(m.point.y, g) - h - l - d : g - h - l - d, B = e < m.point.y))) : (f = Math.max(m.bounds.y1,
                        b.y1), g = Math.min(m.bounds.y2, b.y2), d = 0 <= p.indexOf("range") ? 0 < v ? Math.max(m.bounds.y1, b.y1) + h / 2 + l : Math.min(m.bounds.y2, b.y2) - h / 2 - l : (Math.max(m.bounds.y1, b.y1) + Math.min(m.bounds.y2, b.y2)) / 2, 0 < v ? (e = Math.max(m.point.y, d) - h / 2, e < f && ("bubble" === p || "scatter" === p) && (e = Math.max(m.point.y - h - l, b.y1 + l))) : (e = Math.min(m.point.y, d) - h / 2, e > g - h - l && ("bubble" === p || "scatter" === p) && (e = Math.min(m.point.y + l, b.y2 - h - l))), e = Math.min(e, g - h))
                } else 0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (u = "auto", f =
                    ...
                    b.x2)) / 2, n = 0 > v ? Math.max(m.point.x, d) - k / 2 : Math.min(m.point.x, d) - k / 2, n = Math.max(n, l));
                "vertical" === y && (e += h);
                q.x = n;
                q.y = e;
                q.render(!0);
                w && ("inside" !== u && (0 > p.indexOf("bar") && m.point.x > b.x1 && m.point.x < b.x2 || !B) && (0 > p.indexOf("column") && m.point.y > b.y1 && m.point.y < b.y2 || !B)) && (c.lineWidth = w, c.strokeStyle = s ? s : "gray", c.setLineDash && c.setLineDash(G(r, w)), c.beginPath(), c.moveTo(m.point.x, m.point.y), 0 <= p.indexOf("bar") ? c.lineTo(n + (0 < m.direction ? 0 : k), e + ("horizontal" === y ? h : -h) / 2) : 0 <= p.indexOf("column") ? c.lineTo(n +
                    k / 2, e + ((0 < m.direction ? h : -h) + ("horizontal" === y ? h : -h)) / 2) : c.lineTo(n + k / 2, e + ((e < m.point.y ? h : -h) + ("horizontal" === y ? h : -h)) / 2), c.stroke())
            }
        }
        c = {
            source: c,
                ...
                if (0 < h.length) {
                    for (var y = !1, s = 0; s < h.length; s++)
                        if (w = h[s].x.getTime ? h[s].x.getTime() : h[s].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                            if ("number" !== typeof h[s].y) 0 < s && !(k.connectNullData || y || r) && (c.stroke(),
                                t && b.stroke()), y = !0;
                            else {
                                ...
                                r || y ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || m === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(f.x, f.y), m = k.nullDataLineDashType, c.setLineDash(p)), c.lineTo(w, u), t && b.lineTo(w, u)) : (c.beginPath(), c.moveTo(w,
                                    u), t && (b.beginPath(), b.moveTo(w, u))), y = r = !1) : (c.lineTo(w, u), t && b.lineTo(w, u), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(w, u), t && (b.stroke(), b.beginPath(), b.moveTo(w, u))));
                                f = {
                                    x: w,
                                    y: u
                                };
    ...
    B.prototype.renderStepLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], f, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < h.length) {
                    for (var y = !1, s = 0; s < h.length; s++)
                        if (w = h[s].getTime ? h[s].x.getTime() : h[s].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax &&
                                (!k.connectNullData || !y)))
                            if ("number" !== typeof h[s].y) 0 < s && !(k.connectNullData || y || r) && (c.stroke(), t && b.stroke()), y = !0;
                                ...
                                r || y ? (!r && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || m === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(f.x,
                                    f.y), m = k.nullDataLineDashType, c.setLineDash(p)), c.lineTo(w, x), c.lineTo(w, u), t && (b.lineTo(w, x), b.lineTo(w, u))) : (c.beginPath(), c.moveTo(w, u), t && (b.beginPath(), b.moveTo(w, u))), y = r = !1) : (c.lineTo(w, x), t && b.lineTo(w, x), c.lineTo(w, u), t && b.lineTo(w, u), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(w, u), t && (b.stroke(), b.beginPath(), b.moveTo(w, u))));
                                f = {
                                    x: w,
                                    y: u
                                };
                                s < h.length - 1 && (q !== (h[s].lineColor || e) || m !== (h[s].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(w, u), q = h[s].lineColor || e, c.strokeStyle =
                                    q, c.setLineDash && (h[s].lineDashType ? (m = h[s].lineDashType, c.setLineDash(G(m, k.lineThickness))) : (m = k.lineDashType, c.setLineDash(n))));
                ...
                if (0 < h.length)
                    for (w = !1, r = 0; r < h.length; r++)
                        if (s = h[r].getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w)))
                            if ("number" !== typeof h[r].y) 0 < r && !w &&
                                (k.connectNullData ? b.setLineDash && (0 < u.length && (k.options.nullDataLineDashType || !h[r - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = p, m = k.nullDataLineDashType) : (c(u), u = [])), w = !0;
                            else {
                                ...
                                r < h.length - 1 && (q !== (h[r].lineColor || e) || m !== (h[r].lineDashType || k.lineDashType)) && (q = h[r].lineColor ||
                                    e, u[u.length - 1].newStrokeStyle = q, b.setLineDash && (h[r].lineDashType ? (m = h[r].lineDashType, u[u.length - 1].newLineDashArray = G(m, k.lineThickness)) : (m = k.lineDashType, u[u.length - 1].newLineDashArray = n)));
    ...
    var M = function(a, c, b, d, f, g, l, k, h, m, p, n, e) {
        ...
        !0 === m && (a.save(), a.beginPath(), a.moveTo(c, f), a.lineTo(c + q, f - q), a.lineTo(d - q, f - q),
            a.lineTo(d, f), a.closePath(), l = a.createLinearGradient((d + c) / 2, f - q, (d + c) / 2, f), l.addColorStop(0, g), l.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = l, a.fill(), a.restore());
        ...
        !0 === n && (a.save(), a.beginPath(), a.moveTo(d, b), a.lineTo(d - q, b + q), a.lineTo(d -
            q, f - q), a.lineTo(d, f), l = a.createLinearGradient(d - q, (f + b) / 2, d, (f + b) / 2), l.addColorStop(0, g), l.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = l, l.addColorStop(0, g), l.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = l, a.fill(), a.closePath(), a.restore())
    };
    ...
    B.prototype.renderStackedColumn =
        function(a) {
            var c = a.targetCanvasCtx || this.plotArea.ctx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            b = F(b);
                            t && M(this._eventManager.ghostCtx, s,
                                l, g, r, b, 0, null, !1, !1, !1, !1);
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < r.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (k = 0; k < r.length; k++)
                        if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b <
                                a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
                            var d = a.axisX.convertValueToPixel(b),
                                w = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0,
                                u = w + n << 0,
                                y;
    ...
    B.prototype.renderStackedBar100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                l = [],
                k = 0,
                h, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
            ...
            n = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth &&
                k > p && (k = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, p));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && p < k) && (p = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, k));
            n < k && (n = k);
            n > p && (n = p);
            c.save();
    ...
    B.prototype.renderArea = function(a) {
        ...
        function d() {
            v && (0 < e.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? x = y : 0 > a.axisY.viewportMaximum ? x = k.y1 : 0 < a.axisY.viewportMinimum && (x = l.y2), f.lineTo(s, x), f.lineTo(v.x, x), f.closePath(), f.globalAlpha = e.fillOpacity, f.fill(), f.globalAlpha = 1, t && (g.lineTo(s, x), g.lineTo(v.x, x), g.closePath(), g.fill()), f.beginPath(), f.moveTo(s, w), g.beginPath(), g.moveTo(s, w), v = {
                x: s,
                y: w
            })
        }
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    ...
                    for (var W = !0; r < q.length; r++)
                        if (u = q[r].x.getTime ? q[r].x.getTime() : q[r].x, !(u < a.axisX.dataInfo.viewPortMin ||
                                u > a.axisX.dataInfo.viewPortMax && (!e.connectNullData || !W)))
                            if ("number" !== typeof q[r].y) e.connectNullData || (W || c) || d(), W = !0;
                            else {
                                s = a.axisX.convertValueToPixel(u);
                                w = a.axisY.convertValueToPixel(q[r].y);
                                c || W ? (!c && e.connectNullData ? (f.setLineDash && (e.options.nullDataLineDashType || b === e.lineDashType && e.lineDashType !== e.nullDataLineDashType) && (c = s, b = w, s = p.x, w = p.y, d(), f.moveTo(p.x, p.y), s = c, w = b, v = p, b = e.nullDataLineDashType, f.setLineDash(C)), f.lineTo(s, w), t && g.lineTo(s, w)) : (f.beginPath(), f.moveTo(s, w), t && (g.beginPath(),
                                    g.moveTo(s, w)), v = {
                                    x: s,
                                    y: w
                                ...
                                0 !== q[r].markerSize && (0 <
                                    q[r].markerSize || 0 < e.markerSize) && (u = e.getMarkerProperties(r, s, w, f), h.push(u), I = F(I), t && h.push({
                                    x: s,
                                    y: w,
                                    ctx: g,
                                    type: u.type,
            ...
            if (0 < c.length) {
                if (0 < m.lineThickness) {
                    ...
                    for (var e = 0; e < c.length - 3; e += 3)
                        if (b.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y), t && d.bezierCurveTo(c[e + 1].x, c[e +
                ...
                for (e = 0; e < c.length - 3; e += 3) b.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y), t && d.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x,
                ...
                if (0 < p.length) {
                    ...
                    for (q = !1; n < p.length; n++)
                        if (e = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q)))
                            if ("number" !== typeof p[n].y) 0 < n && !q && (m.connectNullData ?
                                b.setLineDash && (0 < u.length && (m.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = A, z = m.nullDataLineDashType) : (c(), u = [])), q = !0;
                            else {
                                ...
                                n < p.length - 1 && (v !== (p[n].lineColor || x) || z !== (p[n].lineDashType || m.lineDashType)) && (v = p[n].lineColor || x, u[u.length -
                                    1].newStrokeStyle = v, b.setLineDash && (p[n].lineDashType ? (z = p[n].lineDashType, u[u.length - 1].newLineDashArray = G(z, m.lineThickness)) : (z = m.lineDashType, u[u.length - 1].newLineDashArray = B)));
    ...
    B.prototype.renderStepArea = function(a) {
        ...
        function d() {
            v && (0 < e.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? x = y : 0 > a.axisY.viewportMaximum ?
                x = k.y1 : 0 < a.axisY.viewportMinimum && (x = l.y2), f.lineTo(s, x), f.lineTo(v.x, x), f.closePath(), f.globalAlpha = e.fillOpacity, f.fill(), f.globalAlpha = 1, t && (g.lineTo(s, x), g.lineTo(v.x, x), g.closePath(), g.fill()), f.beginPath(), f.moveTo(s, w), g.beginPath(), g.moveTo(s, w), v = {
                    x: s,
                    y: w
                })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    var z = e._colorSet[r % e._colorSet.length],
                        A = e.lineColor = e.options.lineColor ||
                        z,
                        B = A;
                    f.fillStyle = z;
                    f.strokeStyle = A;
                    ...
                    var C = "solid";
                    if (f.setLineDash) {
                        var V = G(e.nullDataLineDashType, e.lineThickness),
                            C = e.lineDashType,
                    ...
                    for (; r < q.length; r++)
                        if (u = q[r].x.getTime ? q[r].x.getTime() : q[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!e.connectNullData || !b))) {
                            var I = w;
                            "number" !== typeof q[r].y ? (e.connectNullData || (b || c) || d(), b = !0) : (s = a.axisX.convertValueToPixel(u), w = a.axisY.convertValueToPixel(q[r].y),
                                c || b ? (!c && e.connectNullData ? (f.setLineDash && (e.options.nullDataLineDashType || C === e.lineDashType && e.lineDashType !== e.nullDataLineDashType) && (c = s, b = w, s = p.x, w = p.y, d(), f.moveTo(p.x, p.y), s = c, w = b, v = p, C = e.nullDataLineDashType, f.setLineDash(V)), f.lineTo(s, I), f.lineTo(s, w), t && (g.lineTo(s, I), g.lineTo(s, w))) : (f.beginPath(), f.moveTo(s, w), t && (g.beginPath(), g.moveTo(s, w)), v = {
                                    x: s,
                                    y: w
                                    ...
                                    A) || C !== (q[r].lineDashType || e.lineDashType)) && (d(), B = q[r].lineColor || A, f.strokeStyle = B, f.setLineDash && (q[r].lineDashType ? (C = q[r].lineDashType, f.setLineDash(G(C, e.lineThickness))) : (C = e.lineDashType, f.setLineDash(W)))), u = e.dataPointIds[r], this._eventManager.objectMap[u] = {
                                    id: u,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: n,
                                    dataPointIndex: r,
                ...
                for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < h.length) {
                        ...
                        for (var W = !0, p = 0; p < h.length; p++) {
                            q = h[p];
                            var I = null,
                                I = 0 <= v.dataPointIndexes[q] ? z[v.dataPointIndexes[q]] : {
                                    x: q,
                                    y: null
                                };
                            if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !W)))
                                if ("number" !== typeof I.y) v.connectNullData || (W || u) || c(), W = !0;
                                else {
                                    ...
                                    l[q] = r - e;
                                    u || W ? (!u && v.connectNullData ? (b.setLineDash && (v.options.nullDataLineDashType || y === v.lineDashType &&
                                        v.lineDashType !== v.nullDataLineDashType) && (u = k.pop(), y = k[k.length - 1], c(), b.moveTo(w.x, w.y), k.push(y), k.push(u), y = v.nullDataLineDashType, b.setLineDash(C)), b.lineTo(n, e), t && s.lineTo(n, e)) : (b.beginPath(), b.moveTo(n, e), t && (s.beginPath(), s.moveTo(n, e))), W = u = !1) : (b.lineTo(n, e), t && s.lineTo(n, e), 0 == p % 250 && (c(), b.moveTo(n, e), t && s.moveTo(n, e), k.push({
                                        x: n,
                                        y: r - da
                                    })));
                                    w = {
                                    ...
                                    0 <= v.dataPointIndexes[q] && 0 !== I.markerSize && (0 < I.markerSize || 0 < v.markerSize) && (q = v.getMarkerProperties(v.dataPointIndexes[q], n,
                                        e, b), f.push(q), markerColor = F(ea), t && f.push({
                                        x: n,
                                        y: e,
                                        ctx: s,
                                        type: q.type,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                var x = a.dataSeriesIndexes[f],
                    ...
                    z = v.dataPoints;
                v.dataPointIndexes = [];
                for (p = 0; p < z.length; p++) x = z[p].x.getTime ? z[p].x.getTime() : z[p].x, v.dataPointIndexes[x] =
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !W)))
                            if ("number" !== typeof I.y) v.connectNullData || (W || s) || c(), W = !0;
                                ...
                                if (a.axisY.logarithmic) {
                                    ...
                                    if (0 >= m[q]) continue;
                                    e =
                                        a.axisY.convertValueToPixel(m[q])
                                ...
                                l[q] = u - e;
                                s || W ? (!s && v.connectNullData ? (b.setLineDash && (v.options.nullDataLineDashType || w === v.lineDashType && v.lineDashType !== v.nullDataLineDashType) && (s = k.pop(), w = k[k.length - 1], c(), b.moveTo(r.x, r.y), k.push(w), k.push(s), w = v.nullDataLineDashType, b.setLineDash(C)), b.lineTo(n, e), t && y.lineTo(n, e)) : (b.beginPath(), b.moveTo(n, e), t && (y.beginPath(), y.moveTo(n, e))), W = s = !1) : (b.lineTo(n, e), t && y.lineTo(n, e), 0 == p % 250 &&
                                    (c(), b.moveTo(n, e), t && y.moveTo(n, e), k.push({
                                        x: n,
                                        y: u - ea
                                    })));
                                r = {
                                ...
                                p < z.length - 1 && (B !== (z[p].lineColor || A) || w !== (z[p].lineDashType || v.lineDashType)) && (c(), b.beginPath(), b.moveTo(n, e), k.push({
                                    x: n,
                                    y: u - ea
                                }), B = z[p].lineColor || A, b.strokeStyle = B, b.setLineDash && (z[p].lineDashType ? (w = z[p].lineDashType, b.setLineDash(G(w, v.lineThickness))) : (w = v.lineDashType, b.setLineDash(V))));
                                if (0 <= v.dataPointIndexes[q]) {
                ...
                if (m = a.dataSeriesIndexes[h], p = this.data[m], n = p.dataPoints, 0 < n.length)
                    for (c.strokeStyle = "#4572A7 ", d = 0; d < n.length; d++)
                        if (f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[d].y) {
                            ...
                            var e = n[d].z,
                                r = 2 * Math.max(Math.sqrt((l === k ? b / 2 : q + (b - q) / (l -
                                    k) * (e - k)) / Math.PI) << 0, 1),
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < m.length) {
                    ...
                    for (var p = 0, n = 0, d = 0; d < m.length; d++)
                        if (f = m[d].getTime ? f = m[d].x.getTime() : f = m[d].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[d].y) {
                            f = a.axisX.convertValueToPixel(f);
    ...
    B.prototype.renderCandlestick = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            c.rect(d.x1, d.y1, d.width, d.height);
            c.clip();
            t && (b.beginPath(), b.rect(d.x1, d.y1,
                    ...
                    for (var w = 5 < n && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? p = s[f].x.getTime() : p = s[f].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                            ...
                            r.type ? (c.moveTo(g - v, k), c.lineTo(g - v, Math.min(l, m)), c.stroke(), c.moveTo(g - v, Math.max(l, m)), c.lineTo(g - v, h), c.stroke(), M(c, u, Math.min(l, m), y, Math.max(l, m), s[f].y[0] <= s[f].y[3] ? r.risingColor : d, x, d, w, w, !1, !1, r.fillOpacity), t && (d = F(z), b.strokeStyle = d, b.moveTo(g - v, k), b.lineTo(g - v, Math.min(l, m)), b.stroke(), b.moveTo(g - v, Math.max(l, m)), b.lineTo(g - v, h), b.stroke(), M(b, u, Math.min(l, m), y, Math.max(l, m), d, 0, null, !1, !1, !1, !1))) : "ohlc" === r.type && (c.moveTo(g - v, k), c.lineTo(g - v, h), c.stroke(), c.beginPath(), c.moveTo(g,
                                l), c.lineTo(u, l), c.stroke(), c.beginPath(), c.moveTo(g, m), c.lineTo(y, m), c.stroke(), t && (d = F(z), b.strokeStyle = d, b.moveTo(g - v, k), b.lineTo(g - v, h), b.stroke(), b.beginPath(), b.moveTo(g, l), b.lineTo(u, l), b.stroke(), b.beginPath(), b.moveTo(g, m), b.lineTo(y, m), b.stroke()));
            ...
            for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < n.length)
                    for (var e = 5 < k && p.bevelEnabled ? !0 : !1, f = 0; f < n.length; f++)
                        if (n[f].getTime ? l = n[f].x.getTime() : l = n[f].x, !(l < a.axisX.dataInfo.viewPortMin ||
                                l > a.axisX.dataInfo.viewPortMax) && null !== n[f].y && n[f].y.length && "number" === typeof n[f].y[0] && "number" === typeof n[f].y[1]) {
    ...
    B.prototype.renderRangeArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.rect(g.x1, g.y1, g.width, g.height);
            b.clip();
            t && (d.beginPath(), d.rect(g.x1, g.y1,
                    ...
                    for (var B = !0; n < m.length; n++)
                        if (s = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !B)))
                            if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                ...
                                p || B ? (h.connectNullData && !p ? (b.setLineDash && (h.options.nullDataLineDashType ||
                                    v === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (l[l.length - 1].newLineDashArray = A, v = h.nullDataLineDashType, b.setLineDash(z)), b.lineTo(e, q), t && d.lineTo(e, q), l.push({
                                    x: e,
                                    y: r
                                ...
                                n < m.length -
                                    1 && (x !== (m[n].lineColor || y) || v !== (m[n].lineDashType || h.lineDashType)) && (c(), x = m[n].lineColor || y, l[l.length - 1].newStrokeStyle = x, b.strokeStyle = x, b.setLineDash && (m[n].lineDashType ? (v = m[n].lineDashType, l[l.length - 1].newLineDashArray = G(v, h.lineThickness), b.setLineDash(l[l.length - 1].newLineDashArray)) : (v = h.lineDashType, l[l.length - 1].newLineDashArray = A, b.setLineDash(A))));
        ...
        function c(a, c) {
            ...
            if (0 < e.length) {
                ...
                for (f = 0; f < e.length - 3; f += 3) b.bezierCurveTo(e[f + 1].x, e[f + 1].y,
                    e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y), t && d.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y);
                e = ua(r, 2);
                    ...
                    for (n = !1; m < h.length; m++)
                        if (p = h[m].x.getTime ? h[m].x.getTime() : h[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))
                            if (null !== h[m].y && h[m].y.length && "number" === typeof h[m].y[0] && "number" === typeof h[m].y[1]) {
                                ...
                                m < h.length - 1 && (u !== (h[m].lineColor || w) || y !== (h[m].lineDashType || k.lineDashType)) && (u = h[m].lineColor || w, q[q.length - 1].newStrokeStyle = u, b.setLineDash && (h[m].lineDashType ? (y = h[m].lineDashType, q[q.length - 1].newLineDashArray = G(y, k.lineThickness)) : (y = k.lineDashType, q[q.length - 1].newLineDashArray = x)));
                                if (0 !== h[m].markerSize && (0 < h[m].markerSize || 0 < k.markerSize)) {
                                    var A =
                                        k.getMarkerProperties(m, p, n, b);
                                    f.push(A);
                                    var B = F(z);
                                    t && f.push({
                                        x: p,
                                ...
                                n = !1
                            } else 0 < m && !n && (k.connectNullData ? b.setLineDash && (0 < q.length && (k.options.nullDataLineDashType || !h[m - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = v, y = k.nullDataLineDashType) : (c(x, w), q = [], r = [])), n = !0;
                    c(x, w);
                    N.drawMarkers(f)
                }
            }
    ...
    var Ga = function(a, c, b, d, f, g, l, k, h) {
        if (!(0 > b)) {
            ...
            a.save();
            a.globalAlpha = k;
            "pie" === f ? (a.beginPath(), a.moveTo(c.x, c.y), a.arc(c.x, c.y, b, g, l, !1), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === f && (a.beginPath(), a.arc(c.x, c.y, b, g, l, !1),
                0 <= h && a.arc(c.x, c.y, h * b, l, g, !0), a.closePath(), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
            a.globalAlpha = 1;
            a.restore()
        }
    };
    B.prototype.renderPie = function(a) {
        function c() {
            if (m && p) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < p.length; f++) {
                    ...
                    l.indexLabelLineColor = g.indexLabelLineColor ? g.indexLabelLineColor : m.options.indexLabelLineColor ?
                        m.options.indexLabelLineColor : g.color ? g.color : m._colorSet[f % m._colorSet.length];
                    ...
                    l.indexLabelFontWeight = g.indexLabelFontWeight ?
                        g.indexLabelFontWeight : m.indexLabelFontWeight;
                    ...
                    l.indexLabelMaxWidth = g.indexLabelMaxWidth ? g.indexLabelMaxWidth : m.indexLabelMaxWidth ? m.indexLabelMaxWidth :
                        0.33 * e.width;
        ...
        function b(a) {
            ...
            for (b = 0; b < p.length; b++) {
                ...
                if (d > c) {
                    ...
                    } else if (0 < Math.abs(q[b].center.x - x.x) || 0 < Math.abs(q[b].center.y - x.y)) q[b].center.x = x.x + f * (1 - a), q[b].center.y = x.y + g * (1 - a), k = !0;
                    k && (f = {}, f.dataSeries = m, f.dataPoint = m.dataPoints[b],
            ...
            a.lineJoin = "round";
            for (b = b = 0; b < p.length; b++) c = q[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== m.indexLabelPlacement ? -(c.indexLabelTextBlock.width + n) :
        ...
        function g(a, b, c) {
            ...
            if (0 <= a && a < p.length) {
                ...
                l = f(a);
                m = h = 0;
                0 > b ? (m = "right" === k.hemisphere ? n : l, e = b, null !== m && (n = -b, b = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - (q[m].indexLabelTextBlock.y + q[m].indexLabelTextBlock.height / 2), b - n < r && (h = -n, m = g(m, h, c + 1), +m.toFixed(y) > +h.toFixed(y) && (e = b > r ? -(b - r) : -(n - (m - h)))))) : 0 < b && (m = "right" === k.hemisphere ? l : n, e = b, null !== m && (n = b, b = q[m].indexLabelTextBlock.y -
                    q[m].indexLabelTextBlock.height / 2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2), b - n < r && (h = n, m = g(m, h, c + 1), +m.toFixed(y) < +h.toFixed(y) && (e = b > r ? b - r : n - (h - m)))));
                e && (c = k.indexLabelTextBlock.y + e, b = 0, b = "right" === k.hemisphere ? x.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - x.y, 2)) : x.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - x.y, 2)), k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u ? (h = (a - 1 + q.length) % q.length, h = q[h], a = q[(a + 1 + q.length) % q.length], "left" === k.hemisphere && "right" === h.hemisphere && b > h.indexLabelTextBlock.x ?
                    ...
                    b, k.indexLabelAngle = Math.atan2(k.indexLabelTextBlock.y - x.y, k.indexLabelTextBlock.x - x.x))
            }
            return e
        }
        ...
        function l() {
            ...
            for (var b = a = 0, c = 0, k = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                ...
                for (a = 0; a < p.length; a++)
                    if (l = q[a], v = l.indexLabelTextBlock.measureText(), 0 !== v.height && 0 !== v.width) v = v = 0, "right" === l.hemisphere ? (v = e.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width + n), v *= -1) : v = e.x1 - (l.indexLabelTextBlock.x -
                            ...
                            if (null !== h) {
                                ...
                                if (l = 0 > z) {
                                    ...
                                    var m = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2,
                                        r = u.indexLabelTextBlock.y + u.indexLabelTextBlock.height /
                                        2,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var m = this.data[a.dataSeriesIndexes[0]],
                ...
                t = 0;
            a = !1;
            for (var B = 0; B < p.length; B++) t += Math.abs(p[B].y), !a && ("undefined" !== typeof p[B].indexLabel && null !== p[B].indexLabel && 0 < p[B].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof p[B].label && null !== p[B].label && 0 < p[B].label.toString().length) && (a = !0);
            if (0 !== t) {
                a = a || "undefined" !== typeof m.indexLabel && null !== m.indexLabel && 0 < m.indexLabel.toString().length;
                var C = "inside" !== m.indexLabelPlacement &&
                ...
                this.pieDoughnutClickHandler = function(a) {
                    h.isAnimating || !z(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && h._animator.animate(0, 500, function(a) {
                        b(a);
                        k()
                    }))
                };
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                    ...
                    for (b = 0; b < p.length; b++) {
                        ...
                        d > c && Ga(h.plotArea.ctx, q[b].center, q[b].radius,
                            g, m.type, c, d, m.fillOpacity, q[b].percentInnerRadius);
                        if (f) break
                    }
                    k()
                }, function() {
    ...
    B.prototype.exportChart = function(a) {
    ...
    ma.prototype.render = function() {
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ?
                ...
                d = c.y1 + 2 + (this.maxWidth / 2 - m.width / 2), f = 90, h = "right", this.width = m.height, this.height = m.width) : "center" === this.horizontalAlign && (d = a.y1 + (a.height / 2 - m.height / 2), b = a.x1 + (a.width / 2 - m.width / 2), h = "center", this.width = m.width, this.height = m.height), k = "center");
            g.x = b;
            g.y = d;
            g.angle = f;
            g.horizontalAlign = k;
    ...
    wa.prototype.render = function() {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
            ...
            g = 0,
            l = 0,
            k = this.markerMargin = this.chart.options.legend && !z(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
        this.height = 0;
        var h = [],
            m = [];
                ...
                if ("pie" !== n.type && "doughnut" !== n.type &&
                    ...
                    for (var t = 0; t < n.dataPoints.length; t++) {
                        var x = n.dataPoints[t],
                            ...
                            x.color : n.color ? n.color : n._colorSet[t % n._colorSet.length],
                            ...
                            u = x.legendMarkerBorderThickness ? x.legendMarkerBorderThickness : n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness : x.markerBorderThickness || n.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0,
                            q = this.chart.replaceKeywordsWithValue(q, x, n, t),
                            e = {
                                markerType: e,
                                markerColor: r,
                                text: q,
        ...
        for (p = c = 0; p < m.length; p++) {
            ...
            for (x = t = 0; x < n.items.length; x++) {
                ...
                if ("line" === e.chartType || "stepLine" === e.chartType || "spline" === e.chartType) this.ctx.strokeStyle = e.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight /
                    8), this.ctx.beginPath(), this.ctx.moveTo(r - 0.1 * this.lineHeight, w + this.lineHeight / 2), this.ctx.lineTo(r + 0.85 * this.lineHeight, w + this.lineHeight / 2), this.ctx.stroke(), q -= 0.1 * this.lineHeight;
    ...
    $.prototype.getDataPointAtX = function(a, c) {
        ...
        for (;;) {
            ...
            if (0 <= g && g < this.dataPoints.length) {
                ...
                p - f && p + f >= this.dataPoints.length) break; - 1 === l ? (f++, l = 1) : l = -1
        }
    ...
    $.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        for (;;) {
            ...
            if (0 <= g && g < this.dataPoints.length) {
                ...
                n + f >= this.dataPoints.length) break; - 1 === l ? (f++, l = 1) : l = -1
        }
        a = null;
    ...
    C.prototype.createExtraLabelsForLog = function(a) {
        ...
        if (!(5 < a)) {
            ...
            if (Math.log(this.range) / Math.log(c / this.viewportMinimum) < this.noTicks - 1) {
                for (var b = C.getNiceNumber((c - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length),
    ...
    C.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && b && !this.logarithmic)
            for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum),
                    this.intervalType, this.interval), f = Ha(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < f; Ha(b, k, this.intervalType)) a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
                axis: this.options,
                value: b,
            ...
            if (this.labels) {
                a = Math.ceil(k);
                for (var k = Math.ceil(this.intervalStartPosition),
                        n = !1, b = k; b < this.viewportMaximum; b += a)
            ...
            if (this.logarithmic && !this.equidistantInterval) {
                ...
                for (var e = 0; e < this.logLabelValues.length; e++) b = this.logLabelValues[e], b < this.viewportMinimum || (a = this.labelFormatter ? this.labelFormatter({
                    ...
                    this.labels[b] : ca(b, this.valueFormatString, this.chart._cultureInfo), a = new U(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: g,
                        maxHeight: l,
        ...
        if ("bottom" === this._position ||
            ...
            typeof this.options.labelMaxWidth ? 0.5 * this.chart.width >> 0 : this.options.labelMaxWidth, this.chart.panEnabled || (l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
        ...
        if (this.labelAutoFit || this.options.labelAutoFit)
            if (z(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                if (g = 0.9 * h >> 0, n = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                        if (a =
                            ...
                            if (this.sessionVariables.labelMaxHeight =
                                ...
                                g ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelWrap = this.labelWrap);
                            else {
                                if (z(this.options.labelWrap))
                                    if (!z(this.options.labelMaxWidth)) this.options.labelMaxWidth < g ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = d) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight =
                                        l);
                                    else if (!z(c))
                                    if (d = q.width + c.width >> 0, e = this.labelFontSize, n < g) d - 2 * g > k && (k = d - 2 * g, d >= 2 * g && d < 2.2 * g ? (this.sessionVariables.labelMaxWidth = g, z(this.options.labelFontSize) && 12 < e && (e = Math.floor(12 / 13 * e), a.measureText()), this.sessionVariables.labelFontSize = z(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : d >= 2.2 * g && d < 2.8 * g ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = s, this.sessionVariables.labelFontSize = e) : d >= 2.8 *
                                    ...
                                    for (this.sessionVariables.labelFontSize = z(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, d = 0; d < this._labels.length; d++) a = this._labels[d].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, n), s), q = a.measureText(), d < this._labels.length - 1 && (e = d + 1, c = this._labels[e].textBlock, c.maxWidth =
                    ...
                    for (b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = z(this.options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth :
            ...
            if (g = z(this.options.labelMaxWidth) ?
                0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                this.sessionVariables.labelFontSize = this.labelFontSize;
                this.sessionVariables.labelMaxWidth = g;
                this.sessionVariables.labelMaxHeight = l;
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            if ("outside" === g.labelPlacement) {
                ...
                if ("left" === this._position || "right" === this._position) w = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight :
                    g.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                c = z(g.options.labelBackgroundColor) ? "#EEEEEE" : g.options.labelBackgroundColor
    ...
    C.setLayoutAndRender = function(a, c, b, d,
        f, g) {
        ...
        if ("normal" === f) {
            ...
            for (; 4 > q;) {
                var M = 0,
                    ...
                    R = 0;
                if (b && 0 < b.length)
                    for (y = [], e = S = 0; e < b.length; e++) y.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)), S += y[e], D += b[e] ? b[e].margin : 0;
                else y.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                L.push(y);
                if (d && 0 < d.length)
                    for (x = [], e = R = 0; e < d.length; e++) x.push(Math.ceil(d[e] ?
                        d[e].createLabelsAndCalculateWidth() : 0)), R += x[e], Q += d[e] ? d[e].margin : 0;
                ...
                if (a && 0 < a.length)
                    for (t = [], e = X = 0; e < a.length; e++) a[e] && (a[e].lineCoordinates = {}), a[e].lineCoordinates.width = Math.abs(h - l), a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width),
                        t.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateHeight() : 0)), X += t[e], f += a[e] ? a[e].margin : 0;
                else t.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                I.push(t);
                if (c && 0 < c.length)
                    for (u = [], e = T = 0; e < c.length; e++) c[e] && (c[e].lineCoordinates = {}), c[e].lineCoordinates.width = Math.abs(h - l), c[e].title && (c[e]._titleTextBlock.maxWidth = 0 < c[e].titleMaxWidth && c[e].titleMaxWidth < c[e].lineCoordinates.width ? c[e].titleMaxWidth : c[e].lineCoordinates.width), u.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateHeight() :
                        0)), T += u[e], K += c[e] ? c[e].margin : 0;
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) a[e] && (a[e].lineCoordinates.x1 = l, h = Math.round(g.x2 - R - Q > p.width - 10 ? p.width - 10 : g.x2 - R - Q), a[e]._labels && 1 < a[e]._labels.length && (k = m = 0, m = a[e]._labels[1], k = "dateTime" === a[e].chart.plotInfo.axisXValueType ? a[e]._labels[a[e]._labels.length - 2] : a[e]._labels[a[e]._labels.length - 1], r = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height -
                        ...
                        a[e].lineCoordinates.x2 = h, a[e].lineCoordinates.width = h - l, a[e].lineCoordinates.y1 = k, a[e].lineCoordinates.y2 = k, a[e].bounds = {
                            x1: l,
                            y1: k,
                            x2: h,
                            y2: m - (X + f - t[e] - M),
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) c[e].lineCoordinates.x1 = Math.round(g.x1 + S + D), c[e].lineCoordinates.x2 = Math.round(g.x2 - R - Q > p.width - 10 ? p.width - 10 : g.x2 - R - Q), c[e].lineCoordinates.width = Math.abs(h - l), c[e]._labels && 1 < c[e]._labels.length && (m = c[e]._labels[1], k = "dateTime" === c[e].chart.plotInfo.axisXValueType ?
                        ...
                        m = Math.round(g.y2 + c[e].margin), c[e].lineCoordinates.y1 = k + T + K - P, c[e].lineCoordinates.y2 = k, c[e].bounds = {
                            x1: l,
                            y1: k + (T + K - u[e] - P),
                            x2: h,
                            y2: m,
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) D = 10, b[e] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), D = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, k = Math.round(g.y1 + T + K < Math.max(D, 10) ? Math.max(D, 10) : g.y1 + T + K), h = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1),
                        D = 0 < a.length ? 0 : b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[0].textBlock.height / 2 : 10, m = Math.round(g.y2 - X - f - D), b[e].lineCoordinates = {
                            x1: h - N,
                            y1: k,
                            x2: h - N,
                            y2: m,
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 :
                        ...
                        d[e].titleMaxWidth < d[e].lineCoordinates.height ? d[e].titleMaxWidth : d[e].lineCoordinates.height), O += x[e] + d[e].margin);
                if (a && 0 < a.length)
                ...
                if (0 < q) {
                    ...
                    if (d && 0 < d.length)
                        for (e = 0; e < d.length; e++) G = J[q - 1][e] === J[q][e] ?
                            !0 : !1;
                    else G = !0
                }
                if (C && E && F && G) break;
            ...
            for (; 4 > q;) {
                ...
                L.push(r);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) b[e].lineCoordinates = {}, l = Math.round(g.x1 + X + f), h =
                ...
                if (b && 0 < b.length)
                    for (v = [], e = O = 0; e < b.length; e++) v.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)), O += v[e] + b[e].margin, D += b[e].margin;
                else v.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                s.push(v);
                if (d && 0 < d.length)
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && 0 < d[e]._labels.length && (m = d[e]._labels[0], k = d[e]._labels[d[e]._labels.length -
                ...
                if (p.panEnabled)
                    for (e = 0; e < b.length; e++) v[e] = p.sessionVariables.axisY.height;
                else
                    for (e = 0; e < b.length; e++) p.sessionVariables.axisY.height = v[e];
                if (b && 0 < b.length)
                    for (e = b.length -
                        1; 0 <= e; e--) k = Math.round(g.y2), m = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = k - (v[e] + b[e].margin + M), b[e].lineCoordinates.y2 = k - (v[e] + b[e].margin + M), b[e].bounds = {
                        x1: l,
                ...
                if (d && 0 < d.length)
                    for (e = d.length - 1; 0 <= e; e--) d[e] &&
                        (k = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + d[e].margin + P)), d[e].lineCoordinates.y1 = m, d[e].lineCoordinates.y2 = m, d[e].bounds = {
                            x1: l,
                            y1: k + (d[e].margin + P),
                            x2: h,
                            y2: m,
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        l = Math.round(g.x1 + f);
                        k =
                            d && 0 < d.length ? Math.round(d[0] ? d[0].lineCoordinates.y2 : g.y1 < Math.max(D, 10) ? Math.max(D, 10) : g.y1) : g.y1 < Math.max(D, 10) ? Math.max(D, 10) : g.y1;
                        ...
                        if (b && 0 < b.length)
                            for (D = 0; D < b.length; D++) b[D] && b[D].labelAutoFit && (h = 0 > b[D].labelAngle ? Math.max(h, t) : 0 === b[D].labelAngle ? Math.max(h, t / 2) : h, l = 0 > b[D].labelAngle || 0 === b[D].labelAngle ?
                                h - X : l);
                        if (d && 0 < d.length)
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) {
                        ...
                        m = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : g.y2 - O > p.height - Math.max(D, 10) ? p.height - Math.max(D, 10) : g.y2 - O) : g.y2 > p.height - Math.max(D, 10) ? p.height - Math.max(D, 10) : g.y2;
                        if (b && 0 < b.length)
                            for (D = 0; D < b.length; D++) b[D] && b[D].labelAutoFit && (h =
                                0 > b[D].labelAngle ? Math.max(h, t) : 0 === b[D].labelAngle ? Math.max(h, t / 2) : h, l = 0 > b[D].labelAngle || 0 === b[D].labelAngle ? h - T : l);
                        if (d && 0 < d.length)
                            for (D = 0; D < d.length; D++) d[D] && d[D].labelAutoFit && (h = d[D].lineCoordinates.x2, l = h - T);
                        c[e].lineCoordinates = {
                            x1: h + N,
                            y1: k,
                            x2: h + N,
                ...
                if (0 < q) {
                    ...
                    if (d && 0 < d.length)
                        for (e =
                            0; e < d.length; e++) G = I[q - 1][e] === I[q][e] ? !0 : !1;
                    else G = !0
                }
                if (C && E && F && G) break;
                q++
                ...
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], d = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, l = this.viewportMaximum, k = this.lineCoordinates.width / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                        ...
                        p.position > this.viewportMaximum ||
                            !(h === this._labels.length - 1 || g < Math.log(l / p.position) * k / d) || (c.push(p), l = p.position, g = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = c
                } else {
            ...
            if ("left" === this._position || "right" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], m, l = this.viewportMaximum, k = this.lineCoordinates.height / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                        p = this._labels[h];
                        if (p.position < this.viewportMinimum) break;
                        p.position > this.viewportMaximum || !(h === this._labels.length - 1 || m < Math.log(l / p.position) * k) || (c.push(p), l = p.position, m = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width *
    ...
    C.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            for (d = 0; d < this._stripLineLabels.length; d++)
                if (m = this.stripLines[d], b = this._stripLineLabels[d], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum ||
                        isNaN(this.range))) {
    ...
    C.prototype.renderAxisLine = function() {
        ...
        } else "left" !== this._position && "right" !== this._position || !this.lineThickness || (a.lineWidth = this.lineThickness, a.strokeStyle = this.lineColor, a.setLineDash && a.setLineDash(G(this.lineDashType, this.lineThickness)), c = 1 === this.lineThickness % 2 ? (this.lineCoordinates.x1 << 0) + 0.5 : this.lineCoordinates.x1 << 0, a.beginPath(), a.moveTo(c, this.lineCoordinates.y1), a.lineTo(c, this.lineCoordinates.y2), a.stroke());
        a.restore()
    };
    ...
    C.prototype.calculateAxisParameters = function() {
        if (this.logarithmic) this.calculateLogarithamicAxisParameters();
            ...
            if (z(this.options.viewportMinimum) &&
                !z(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum)) this.viewportMinimum = this.sessionVariables.newViewportMinimum;
            else if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum;
            if (z(this.options.viewportMaximum) && !z(this.sessionVariables.newViewportMaximum) && !isNaN(this.sessionVariables.newViewportMaximum)) this.viewportMaximum = this.sessionVariables.newViewportMaximum;
            ...
            if ("axisX" === this.type) {
                ...
                Infinity !== this.dataInfo.minDiff ? l = this.dataInfo.minDiff : 1 < g - f ? l = 0.5 * Math.abs(g - f) : (l =
                    1, b && (c = !0))
            ...
            if ("axisX" === this.type && b) {
                this.intervalType || (d / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : d / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : d / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : d / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : d / 20 <= a ? (this.interval = 20, this.intervalType = "millisecond") : d / 50 <= a ? (this.interval = 50, this.intervalType = "millisecond") : d / 100 <= a ? (this.interval =
                    ...
                    a ? (this.interval = 1, this.intervalType = "month") : d / (2 * H.monthDuration) <= a ? (this.interval = 2, this.intervalType = "month") : d / (3 * H.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : d / (6 * H.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = d / (1 * H.yearDuration) <= a ? 1 : d / (2 * H.yearDuration) <= a ? 2 : d / (4 * H.yearDuration) <= a ? 4 : Math.floor(C.getNiceNumber(d / (a - 1), !0) / H.yearDuration), this.intervalType = "year"));
                ...
                if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = "axisX" === this.type ? f - l / 2 : Math.floor(f /
            ...
            if (null ===
                ...
                } else this.intervalType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? f - l / 2 : Math.floor(f / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ?
            ...
            z(this.sessionVariables.newViewportMinimum) && (this.viewportMinimum =
                Math.max(this.viewportMinimum, this.minimum));
            z(this.sessionVariables.newViewportMaximum) && (this.viewportMaximum = Math.min(this.viewportMaximum, this.maximum));
    ...
    C.prototype.calculateLogarithamicAxisParameters = function() {
        ...
        "axisX" === this.type ? (d = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, f = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax, 1 === f / d && (l = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ?
        ...
        this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = C.getNiceExponent(Math.log(l) / c / (a - 1), !0), b = C.getNiceNumber(linearRange / (a - 1), !0));
    ...
    na.prototype.render = function() {
        ...
        if (0 < c) {
            ...
            this.ctx.setLineDash &&
                this.ctx.setLineDash(G(this.lineDashType, c));
                    ...
                    if (this.chart.axisX)
                        for (k = 0; k < this.chart.axisX.length; k++)
                            for (l = this.chart.axisX[k].convertPixelToValue({
                                    x: a
                                }), h = null, d = 0; d < this.chart.axisX[k].dataSeries.length; d++)(h = this.chart.axisX[k].dataSeries[d].getDataPointAtX(l,
                                b)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[k].dataSeries[d], null !== h.dataPoint.y && f.push(h));
                    if (this.chart.axisX2)
                        for (k = 0; k < this.chart.axisX2.length; k++)
                ...
                if (b = "", b = this.getToolTipInnerHTML({
                    ...
                    try {
                        this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor :
                            ...
                            this.fontStyle ? this.fontStyle : t ? "italic" : "normal"
                    } catch (m) {}
            ...
            if ((f = this.chart._eventManager.objectMap[f.dataSeries.dataPointIds[f.index]]) && f.objectType && "dataPoint" === f.objectType) {
                ...
                !1 === g.highlightEnabled || !0 !== d.highlightEnabled && !0 !== g.highlightEnabled || ("line" === d.type || "stepLine" ===
                    ...
                    "rangeColumn" === d.type ? M(c, f.x1, f.y1, f.x2, f.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === d.type || "doughnut" === d.type ? Ga(c, f.center, f.radius, "white", d.type, f.startAngle, f.endAngle, 0.3, f.percentInnerRadius) : "candlestick" === d.type ? (c.globalAlpha = 1, c.strokeStyle = f.color, c.lineWidth = 2 * f.borderThickness, d = 0 === c.lineWidth % 2 ? 0 : 0.5, c.beginPath(), c.moveTo(f.x3 - d, Math.min(f.y2, f.y3)), c.lineTo(f.x3 - d, Math.min(f.y1, f.y4)), c.stroke(), c.beginPath(), c.moveTo(f.x3 - d, Math.max(f.y1, f.y4)), c.lineTo(f.x3 - d, Math.max(f.y2,
                        f.y3)), c.stroke(), M(c, f.x1, Math.min(f.y1, f.y4), f.x2, Math.max(f.y1, f.y4), "transparent", 2 * f.borderThickness, f.color, !1, !1, !1, !1), c.globalAlpha = 1) : "ohlc" === d.type && (c.globalAlpha = 1, c.strokeStyle = f.color, c.lineWidth = 2 * f.borderThickness, d = 0 === c.lineWidth % 2 ? 0 : 0.5, c.beginPath(), c.moveTo(f.x3 - d, f.y2), c.lineTo(f.x3 - d, f.y3), c.stroke(), c.beginPath(), c.moveTo(f.x3, f.y1), c.lineTo(f.x1, f.y1), c.stroke(), c.beginPath(), c.moveTo(f.x3, f.y4), c.lineTo(f.x2, f.y4), c.stroke(), c.globalAlpha = 1))
            }
        }
        c.restore();
        c.globalAlpha =
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,
            function(a) {
                ...
                if ("x" === a)
                    ...
                    } else return ca(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = "#,##0.########",
                        g._cultureInfo);
                else return "y" === a ? ca(h, c.yValueFormatString ? c.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : b.yValueFormatString = "#,##0.########", g._cultureInfo) : "z" === a ? ca(h, c.zValueFormatString ? c.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : b.zValueFormatString = "#,##0.########", g._cultureInfo) : h
            })
    };
    ...
    var E = {
            yScaleAnimation: function(a, c) {
                if (0 !== a) {
                    ...
                    b.drawImage(d, 0, 0, d.width,
                        d.height, 0, f - f * a, b.canvas.width / P, a * b.canvas.height / P)
                }
            },
            xScaleAnimation: function(a, c) {
                if (0 !== a) {
                    var b = c.dest,
                        d = c.source.canvas,
                        f = c.animationBase;
                    b.drawImage(d, 0, 0, d.width, d.height, f - f * a, 0, a * b.canvas.width / P, b.canvas.height / P)
                }
            },
            ...
            fadeInAnimation: function(a, c) {
                if (0 !== a) {
                    ...
                    b.globalAlpha = a;
                    b.drawImage(d,
                        0, 0, d.width, d.height, 0, 0, b.canvas.width / P, b.canvas.height / P);
                    b.restore()
                }
            },
            easing: {
        ...
        ja = {
            ...
            formatDate: function(a, c, b) {
                b = b || "en";
                if (pa[b]) return Ea(a, c || "DD MMM YYYY", new oa(b));
                throw "Unknown Culture Name";
            }
        };
