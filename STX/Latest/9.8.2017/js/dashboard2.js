...
//$('#salesChart').click(function (e) {
  //  window.location.href ="no-of-project.html";

//});
//$('#pieChart').click(function (e) {
  //  window.location.href ="meeting-type.html";
//});
//$('#lineChart').click(function (e) {
  //  window.location.href ="meeting-time.html";
//});

//$('#barChart').click(function (e) {
  //  window.location.href ="project-overdue.html";
//});
